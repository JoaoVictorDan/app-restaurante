	...
	<head>
		...
		<script>
			function editar(id, txt_tarefa) {
				...
				form.action = 'tarefa_controler.php?acao=atualizara'
				form.method = 'post'
				form.className = 'row'
			...
			function remover(id) {
				location.href = 'todas_tarefas.php?acao=removera&id='+id;
			}
		...
		<div class="container app">
			<div class="row">
				<div class="col-sm-3 menu">
					<ul class="list-group">
						<a href="nova_tarefa_cliente.php"><li class="list-group-item">Novo pedido</li></a>
